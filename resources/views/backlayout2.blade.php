...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="{{URL::asset('backend/2/assets/favicon-CvUZKS4z.svg')}}">
    <link rel="icon" type="image/png" href="{{URL::asset('backend/2/assets/favicon-B_cwPWBd.png')}}">
    ...
    <!-- PWA Manifest -->
    <link rel="manifest" href="{{URL::asset('backend/2/assets/manifest-DTaoG9pG.json')}}">
  <script type="module" crossorigin src="{{URL::asset('backend/2/assets/vendor-bootstrap-C9iorZI5.js')}}"></script>
  <script type="module" crossorigin src="{{URL::asset('backend/2/assets/vendor-bootstrap-C9iorZI5.js')}}"></script>
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="elementsSubmenu">
                                <ul class="nav nav-submenu">
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{URL::asset('backend/2/elements.html')}}">
                                            <i class="bi bi-grid"></i>
                                            <span>Overview</span>
                                        </a>
                                    </li>
